            ...
            <div className="row gy-5">
                <div className="col-lg-3">
                    <ul className="privacy-policy-sidebar-menu">
                        <li>
                            <a href="#overview" className="active nav-link">Overview</a>
                        </li>
                        <li>
                            <a href="#data-collection" className="nav-link">Data Collection & Use</a>
                        </li>
                        <li>
                            <a href="#cookies" className="nav-link">Cookies Data</a>
                        </li>
                        <li>
                            <a href="#data-security" className="nav-link">Data Security</a>
                        </li>
                        <li>
                            <a href="#overview2" className="nav-link">Customer Information</a>
                        </li>
                        <li>
                            <a href="#overview3" className="nav-link">Data Collection & Use</a>
                        </li>
                    </ul>
                </div>
                <div className="col-lg-9">
                    <div className="privacy-policy-content">
                        <div className="content-item">
                            <h4 className="title" id="overview">Overview</h4>
                            <p>
                        ...
                        <div className="content-item">
                            <h4 className="title" id="data-collection">Data Collection & Use</h4>
                            <p>
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Assumenda officia vel omnis, odit quidem, expedita nam deserunt molestiae accusamus voluptas aut. Sapiente voluptatem nulla unde quia harum illum ipsum dolore! Lorem ipsum dolor sit amet consectetur adipisicing elit. In dolorem illum molestiae corrupti, maxime sint velit quibusdam officiis ipsam a minima quos voluptates possimus eaque, vitae, veniam consequuntur! Dolorem, architecto.
                            </p>
                        ...
                        <div className="content-item">
                            <h4 className="title" id="cookies">Cookies Data</h4>
                            <p>
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Assumenda officia vel omnis, odit quidem, expedita nam deserunt molestiae accusamus voluptas aut. Sapiente voluptatem nulla unde quia harum illum ipsum dolore! Lorem ipsum dolor sit amet consectetur adipisicing elit. In dolorem illum molestiae corrupti, maxime sint velit quibusdam officiis ipsam a minima quos voluptates possimus eaque, vitae, veniam consequuntur! Dolorem, architecto.
                            </p>
                        </div>
                        <div className="content-item">
                            <h4 className="title" id="data-security">Data Collection & Use</h4>
                            <p>
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Assumenda officia vel omnis, odit quidem, expedita nam deserunt molestiae accusamus voluptas aut. Sapiente voluptatem nulla unde quia harum illum ipsum dolore! Lorem ipsum dolor sit amet consectetur adipisicing elit. In dolorem illum molestiae corrupti, maxime sint velit quibusdam officiis ipsam a minima quos voluptates possimus eaque, vitae, veniam consequuntur! Dolorem, architecto.
                            </p>
                        </div>
                        <div className="content-item">
                            <h4 className="title" id="overview2">Data Cookies</h4>
                            <p>
                        ...
                        <div className="content-item">
                            <h4 className="title" id="overview3">Data Storage</h4>
                            <p>
